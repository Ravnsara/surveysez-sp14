...
{#records exist - process
    ...
    echo '<div align="center">There are ' . $myPager->showTotal() . ' ' . $itemz . '.</div><br />';
	while($row = mysqli_fetch_assoc($result))
	{# process each row
         echo '<div align="center"><a href="' . VIRTUAL_PATH . 'surveys/survey_view.php?id=' . (int)$row['SurveyID'] . '">' . dbOut($row['Title']) . " - " . dbOut($row['Description']) . '</a><br />';
